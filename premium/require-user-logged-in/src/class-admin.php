...
class Admin
{
    ...
    public function form_settings(Form $form)
    {
        ?>
        <tr valign="top">
            <th scope="row"><label for="hf_form_require_user_logged_in"><?php _e( 'Require Users to Be Logged In?', 'html-forms' ); ?></label></th>
            <td>
                ...
                <p class="description"><?php _e( 'Select "Yes" to require users to be logged in to see the form.', 'html-forms' ); ?></p>
            </td>
        </tr>
        <?php
    }
    ...
    public function output_message_settings($form)
    {
        ?>
        <tr valign="top">
            <th scope="row"><label for="hf_form_require_user_logged_in"><?php _e('User Log in Required', 'html-forms'); ?></label></th>
            <td>
                ...
                <p class="description"><?php _e('Message to show when users must be log in to see the form.', 'html-forms'); ?></p>
            </td>
        </tr>
        <?php
    }
