...
abstract class Action {
    ...
    public function hook() {
        add_filter( 'cf_available_form_actions', array( $this, 'register' ) );
        add_action( 'cf_output_form_action_' . $this->type . '_settings', array( $this, 'page_settings' ), 10, 2 );
        add_action( 'cf_process_form_action_' . $this->type, array( $this, 'process' ), 10, 3 );
    }
